...
experiment_dir="${EXPERIMENT_DIR:?Set EXPERIMENT_DIR to an initialized v1.2 directory}"
...
CUDA_VISIBLE_DEVICES="${device}" python train_bridgeadaptclip_v11.py \
    --model_name BridgeAdaptCLIP-v1.2 \
    --checkpoint_state_key bridgeadaptclip_v12 \
