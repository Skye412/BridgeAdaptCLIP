...
experiment_dir="${EXPERIMENT_DIR:?Set EXPERIMENT_DIR to the v1.4 experiment}"
bash scripts/train_bridgeadaptclip_v14.sh
bash scripts/validate_bridgeadaptclip_v14.sh
...
bash scripts/test_bridgeadaptclip_v14.sh

export DIAGNOSTIC_DIR="${experiment_dir}/diagnostics"
export CHECKPOINT_STATE_KEY=bridgeadaptclip_v14
