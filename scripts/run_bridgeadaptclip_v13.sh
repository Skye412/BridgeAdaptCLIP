...
experiment_dir="${EXPERIMENT_DIR:?Set EXPERIMENT_DIR to the v1.3 experiment}"
bash scripts/train_bridgeadaptclip_v13.sh
bash scripts/validate_bridgeadaptclip_v13.sh
...
bash scripts/test_bridgeadaptclip_v13.sh

export DIAGNOSTIC_DIR="${experiment_dir}/diagnostics"
export CHECKPOINT_STATE_KEY=bridgeadaptclip_v13
