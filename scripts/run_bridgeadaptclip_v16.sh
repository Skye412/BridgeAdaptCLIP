...
bash scripts/train_bridgeadaptclip_v16.sh
bash scripts/validate_bridgeadaptclip_v16.sh
...
bash scripts/test_bridgeadaptclip_v16.sh

export DIAGNOSTIC_DIR="${experiment_dir}/diagnostics"
export CHECKPOINT_STATE_KEY=bridgeadaptclip_v16
